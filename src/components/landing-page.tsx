    ...
    <div className="flex flex-col items-center">
      <div className="flex flex-col my-10 items-center">
        ...
        <input
          ...
          className="bg-white mt-10 rounded-lg px-20 py-2 text-center w-90"
          value={search}
          ...
          return (
            <Link href={`/pokemon/${pokemon.id}`} key={pokemon.id}>
              <div className="bg-white rounded-lg w-70 h-70 mt-10 justify-end flex flex-col items-center hover:scale-110 transition-transform duration-200 cursor-pointer capitalize">
                ...
                />
                <h2>{formattedId}</h2>
                <h2 className="capitalize font-bold text-xl">{pokemon.name}</h2>
      ...
      <div className="my-10">
        <button
          onClick={SeeMore}
          className="bg-white text-black py-2 px-4 rounded hover:bg-black hover:text-white transition duration-300 ease-in-out cursor-pointer"
        >
          See More
        </button>
      </div>
